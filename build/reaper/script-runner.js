...
export class ReaperScriptRunner {
     ...
     */
    async executeLuaScript(luaCode) {
...
`;
     ...
     */
    async executePythonScript(pythonCode) {
...
`;
     ...
     */
    async executeRaw(script, isLua = true) {
        const result = isLua
